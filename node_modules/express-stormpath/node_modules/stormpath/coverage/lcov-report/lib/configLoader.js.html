...
module.exports = <span class="fstat-no" title="function not covered" >function (extendWithConfig) {</span>
<span class="cstat-no" title="statement not covered" >  return new stormpathConfig.Loader([</span>
