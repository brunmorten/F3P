...
function Resource(data, dataStore) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!dataStore &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >data instanceof DataStore)</span>{
...
&nbsp;
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (dataStore) {
