...
&nbsp;
var toQueryString = require('../utils').toQueryString;
&nbsp;
...
SamlIdpUrlBuilder.prototype._buildInitializationUrl = function _buildInitializationUrl(initEndpointUrl, parameters) {
  return initEndpointUrl + '?' + toQueryString(parameters);
};
&nbsp;
SamlIdpUrlBuilder.prototype.build = function (/* [options,] callback */) {
  var args = Array.prototype.slice.call(arguments);
  var callback = args.pop();
  var options = args.length &gt; 0 ? <span class="branch-0 cbranch-no" title="branch not covered" >args.shift() </span>: {};
&nbsp;
  var self = this;
  var apiKey = this.apiKey;
&nbsp;
  var parameters = {
    'accountStore.href': options['accountStore.href'],
    'accountStore.nameKey': options['accountStore.nameKey'],
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Fri Jan 15 2016 22:11:01 GMT+0100 (CET)
</div>
</div>
