...
&nbsp;
  this.baseUrl = options.baseUrl || <span class="branch-1 cbranch-no" title="branch not covered" >'https://api.stormpath.com/v1';</span>
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (req.query) {
<span class="cstat-no" title="statement not covered" >    options.qs = req.query;</span>
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (req.body &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >req.body.form)</span>{
<span class="cstat-no" title="statement not covered" >    options.form = req.body.form;</span>
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (req.body) {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (response.statusCode &gt; 399) {
<span class="cstat-no" title="statement not covered" >      return callback(new ResourceError(body || {status:response.statusCode}), null);</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (response.statusCode === 201){
