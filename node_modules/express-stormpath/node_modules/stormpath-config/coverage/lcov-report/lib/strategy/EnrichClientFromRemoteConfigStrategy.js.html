...
<html lang="en">
<head>
    <title>Code coverage report for lib/strategy/EnrichClientFromRemoteConfigStrategy.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/strategy/</a> EnrichClientFromRemoteConfigStrategy.js
    </h1>
    <div class='clearfix'>
...
EnrichClientFromRemoteConfigStrategy.prototype.process = function (config, callback) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (config.skipRemoteConfig) {
