...
<html lang="en">
<head>
    <title>Code coverage report for lib/strategy/LoadAPIKeyConfigStrategy.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/strategy/</a> LoadAPIKeyConfigStrategy.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!mustExist &amp;&amp; config.client.apiKey.id &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >config.client.apiKey.secret)</span> {
