...
&nbsp;
      ...
      if (registerFields.passwordConfirm &amp;&amp; (registerFields.passwordConfirm.enabled || <span class="branch-2 cbranch-no" title="branch not covered" >registerFields.passwordConfirm.required)</span>) {
