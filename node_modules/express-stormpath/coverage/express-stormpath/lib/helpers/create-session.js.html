...
&nbsp;
  cookies.set(accessTokenCookieConfig.name, passwordGrantAuthenticationResult.accessToken, {
    ...
    secure: (accessTokenCookieConfig.https !== null ? accessTokenCookieConfig.https : (<span class="branch-1 cbranch-no" title="branch not covered" >req.protocol === 'https')</span>)
  });
&nbsp;
